...
$\hat{h}+ \gamma h_0^3 \hat{h}_{xxxx}   = 0$
...
<p align="center">
  <img src="CrossValidated/animated_cross_validation.gif" alt="Cross-validation animation" width="70%">
  <br>
  <em>
    <strong>Fig. 3:</strong> Droplet shape evolving under the ODE-derived optimal controls applied to the full PDE, generated by <code>animated_crossvalidation.py</code>.
  </em>
</p>
